...
public class Calculator {
    ...
    private static final List<ArithmeticOperator> arithmeticOperators = List.of(new AdditionOperator(), new DivisionOperator(), new MultiplyOperator() ,new SubtractionOperator());
    /**
     * 간단한 사칙연산을 할 수 있다.
     * 양수로만 계산할 수 있다.
